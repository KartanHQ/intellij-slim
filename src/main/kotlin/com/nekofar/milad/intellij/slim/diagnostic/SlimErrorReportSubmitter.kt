package com.nekofar.milad.intellij.slim.diagnostic
...
class SlimErrorReportSubmitter : ErrorReportSubmitter() {
    ...
    private fun getReportBody(events: Array<out IdeaLoggingEvent>, additionalInfo: String?): String {
        ...
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.nekofar.milad.intellij.slim"))
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/KartanHQ/intellij-slim/issues/new")
